...
class UserAppointments extends StatefulWidget {
  ...
  UserAppointments(this.currentUser);

  UserAppointmentsState createState() =>
      UserAppointmentsState(this.currentUser);
}

class UserAppointmentsState extends State<UserAppointments> {
