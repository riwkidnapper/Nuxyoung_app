...
class DistrictDialog extends StatefulWidget {
  final List<DistrictDao> listProvinces;
  ...
  static show(BuildContext context,
      {@required List<DistrictDao> listProvinces,
  ...
  @override
  _DistrictDialogState createState() => _DistrictDialogState();
}

class _DistrictDialogState extends State<DistrictDialog> {
  List<DistrictDao> listProvincesFilter;
...
//          decoration: BoxDecoration(borderRadius: BorderRadius.circular(16)),
  ...
  Widget buildRowProvince(DistrictDao distric) {
    return GestureDetector(
        onTap: () {
          Navigator.pop(context, distric);
        },
        child: Column(
